...
public class RunningTraceLoggingAspect {
	...
	@Pointcut("execution(* jeff.authentication.common.util..*.*(..))"
			+ "|| execution(* jeff.authentication.common.schedule..*.*(..))"
			+ "|| execution(* jeff.authentication.controller..*.*(..))"
			+ "|| execution(* jeff.authentication.dao..*.*(..))"
			+ "|| execution(* jeff.authentication.service..*.*(..))"
			+ "|| execution(* jeff.authentication.serviceimpl.UserDetailsServiceImpl.loadUserByUsername(..))"
			+ "|| execution(* jeff.authentication.handler..*.*(..))")
