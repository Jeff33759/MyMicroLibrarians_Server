...
import jeff.book2.controller.HandshakeController;
...
public interface InnerApiConst {
	...
	public interface Receive {
		...
		public interface Path {
			 ...
			 * 讓gateway通知的路徑。
			 * */
			public static final String PING = "/ping/book2";
	...
	public interface Send {
		...
		public interface Path {
			 ...
			 * */
			public static final String GW_REGISTER = "/gateway/reg/book2";
			
			/**
			 * Gateway-HeartBeat，向Gateway傳送心跳訊號。
			 * */
			public static final String GW_HEARTBEAT = "/gateway/hb/book2";
