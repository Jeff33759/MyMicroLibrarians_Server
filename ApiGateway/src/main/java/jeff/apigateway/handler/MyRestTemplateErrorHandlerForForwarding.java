...
/**
 * 轉接業務請求給各微服務時，收到錯誤回應的處理。</p>
 * 
 * @author Jeff Huang
 * */
public class MyRestTemplateErrorHandlerForForwarding implements ResponseErrorHandler{
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
		...
		switch(statusCode.series()) {
			case CLIENT_ERROR:
				throw new RestTemplateErrorResException(statusCode,msg);
			case SERVER_ERROR:
				throw new RestTemplateErrorResException(statusCode,msg);
			default:
				throw new RestTemplateErrorResException(statusCode,msg);
