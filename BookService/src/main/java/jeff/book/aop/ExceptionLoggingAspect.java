...
public class ExceptionLoggingAspect {
	...
	/**
	 * 匹配jeff.book.service底下子目錄的所有類別的所有0~多個參數的方法。</p>
	 * */
	@Pointcut("execution(* jeff.book.service..*.*(..))")
	 ...
	 * */
	@Pointcut("execution(* jeff.book.common.util..*.*(..))")
	 ...
	 * */
	@Pointcut("execution(* jeff.book.common.schedule..*.*(..))")
