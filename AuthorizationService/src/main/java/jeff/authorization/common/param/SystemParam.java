package jeff.authorization.common.param;
...
public class SystemParam {
	...
	/**
     * AccessToken解析器，向gateway註冊後賦值，預設null。</p>
     * @see {@link HandshakeServiceImpl #registerWithTheGateway}
     * */
    public JwtParser AT_PARSER = null;
