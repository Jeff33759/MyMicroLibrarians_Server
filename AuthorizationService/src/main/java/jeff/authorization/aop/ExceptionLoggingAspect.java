...
public class ExceptionLoggingAspect {
	...
	/**
	 * 匹配jeff.authorization.service底下子目錄的所有類別的所有0~多個參數的方法。</p>
	 * */
	@Pointcut("execution(* jeff.authorization.service..*.*(..))")
	public void pointcutForService() {
	}
	
	/**
	 * 匹配jeff.authorization.common.util底下子目錄的所有類別的所有0~多個參數的方法。
	 * */
	...
	/**
	 * 匹配jeff.authorization.common.schedule底下子目錄的所有類別的所有0~多個參數的方法。
	 * */
